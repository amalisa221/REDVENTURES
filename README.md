...
3.	Is conversion affected by a cart-focused purchase experience vs. a phone-focused experience?

From the Red Ventures data file, my first step was to determine the Key Performance Indicators (KPIs) needed to create a dashboard for the company's executive team. The KPIs I selected included total orders, phone orders, cart orders, states represented by country, zip codes of sessions, and distinct page views.
...
![REDVENTURES DASHBOARD](redventures.png)
